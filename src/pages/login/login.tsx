                    ...
                    <div className="max-w-md w-full">
                        ...
                        <div className="mt-6 text-center space-y-4">
                            ...
                            <div className="pt-4 border-t border-gray-200">
                                <p className="text-sm text-texto mb-3 font-semibold">Você é vendedor?</p>
                                <Link 
                                    to="/login/vendedor" 
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-verde-claro text-white rounded-lg hover:bg-verde-escuro transition-colors font-medium"
                                >
