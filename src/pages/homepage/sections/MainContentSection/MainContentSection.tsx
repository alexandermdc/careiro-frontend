...
export const MainContentSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-start gap-16 px-[166px] py-16">
      <div className="w-full">
        <h2 className="mb-8 font-t-tulos font-[number:var(--t-tulos-font-weight)] text-verde-escuro text-[length:var(--t-tulos-font-size)] tracking-[var(--t-tulos-letter-spacing)] leading-[var(--t-tulos-line-height)] [font-style:var(--t-tulos-font-style)]">
          Produtos e associações em destaque
        </h2>

        <div className="flex items-center gap-[19px] w-full overflow-x-auto pb-4">
      ...
      <div className="w-full">
        <div className="flex flex-col max-w-[467px] items-start gap-2 mb-8">
        <h2 className="relative self-stretch mt-[-1.00px] font-t-tulos font-[number:var(--t-tulos-font-weight)] text-verde-escuro text-[length:var(--t-tulos-font-size)] tracking-[var(--t-tulos-letter-spacing)] leading-[var(--t-tulos-line-height)] [font-style:var(--t-tulos-font-style)]">
          Conheça nossas feiras
        </h2>
        <p className="relative self-stretch [font-family:'Montserrat',Helvetica] font-normal text-texto text-base tracking-[0] leading-[normal]">
      ...
      <div className="w-full">
        ...
        {categories.map((category, index) => (
          <div
            key={index}
            className="min-w-[263px] w-[263px] h-[200px] items-center justify-center px-[73px] py-[85px] bg-[linear-gradient(0deg,rgba(28,90,22,0.77)_0%,rgba(28,90,22,0.77)_100%),url(https://c.animaapp.com/meda5qjaouVHG5/img/card-categorias-2.png)_50%_50%_/_cover] flex relative rounded-[25px] overflow-hidden cursor-pointer hover:opacity-90 transition-opacity"
          >
      ...
      <div className="w-full">
        ...
        <div className="flex items-start gap-5 w-full overflow-x-auto pb-4">
        {subscriptions.map((subscription, index) => (
          ...
          >
            ...
            <CardContent className="flex flex-col items-start px-4 py-0 relative self-stretch w-full flex-[0_0_auto]">
              <div className="w-[263px] h-6 mt-[-1.00px] mr-[-32.00px] font-medium text-texto text-base leading-[normal] relative [font-family:'Montserrat',Helvetica] tracking-[0]">
                Text
              </div>
      ...
      <Card className="flex w-full items-start gap-2.5 px-0 py-[60px] bg-cinza rounded-[30px] overflow-hidden">
